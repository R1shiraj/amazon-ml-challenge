...
def download_image(image_link, save_folder, save_path=None, retries=3, delay=3):
    # Use save_path if provided, else fall back to default
    if save_path is None:
        filename = Path(image_link).name  # If save_path is not provided, fallback to default
