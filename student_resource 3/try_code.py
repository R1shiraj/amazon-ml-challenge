...
voltage_data = test_data[test_data['entity_name'] == 'voltage'].head(40)
wattage_data = test_data[test_data['entity_name'] == 'wattage'].head(40)
...
def extract_text_from_image(image_path):
    ...
    # width = int(image.shape[1] * 150 / 100)
    # height = int(image.shape[0] * 150 / 100)
    # dim = (width, height)
...
final_predictions[['index', 'prediction']].to_csv('./dataset/try_volt.csv', index=False)
